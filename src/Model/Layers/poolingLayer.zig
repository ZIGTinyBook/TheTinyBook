...
// kernerl_size: [2]
// stride : [2] -> horizontal and vertical
pub fn PoolingLayer(comptime T: type, alloc: *const std.mem.Allocator) type {
    return struct {
        ...
        kernel: []usize, // kernerl_size: [2]
        stride: []usize, // stride : [2] -> horizontal and vertical
        poolingType: PoolingType,
        allocator: *const std.mem.Allocator,

        pub fn create(self: *PoolingLayer(T, alloc)) !Layer.Layer(T, alloc) {
        ...
        pub fn deinit(ctx: *anyopaque) void {
            const self: *PoolingLayer(T, alloc) = @ptrCast(@alignCast(ctx));
